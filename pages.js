...
var buttonRow = '<div class="ms-Grid-row">' +
  ...
  '<div class="ms-Grid-row">' +
    '<div class="ms-Grid-col ms-u-sm4">' +
      '<a class="ms-Button ms-Button--primary" href="/sync"><span class="ms-Button-label"> create event</span></a>' +
    '</div>' +
    '<div class="ms-Grid-col ms-u-sm4">' +
      '<a class="ms-Button ms-Button--primary" href="/delete"><span class="ms-Button-label">delete event</span></a>' +
    '</div>'+
    '<div class="ms-Grid-col ms-u-sm4">' +
      '<a class="ms-Button ms-Button--primary" href="/getEvent"><span class="ms-Button-label">get calendar Events</span></a>' +
    '</div>'+
    '<div class="ms-Grid-col ms-u-sm4">' +
