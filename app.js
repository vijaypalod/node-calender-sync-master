...
app.get('/sync', function(req, res) {
  ...
  var newEvent = {
    ...
    "Start": {
      "DateTime": "2019-03-06T18:00:00",
      "TimeZone": "India Standard Time"
    },
    "End": {
      "DateTime": "2019-03-06T19:00:00",
      "TimeZone": "India Standard Time"
    },
    "Attendees": [
      {
        "EmailAddress": {
          "Address": "milap.p.tank@accenture.com",
          "Name": "milap tank"
        },
        "Type": "Required"
      }
...
outlook.calendar.getEvents({token: token, folderId: 'Inbox', odataParams: queryParams, user: userInfo},
  function(error, result){
    if (error) {
      ...
      res.send(result.value[0].Id);
      deleteId = result.value[0].Id;
    }
  })
})
